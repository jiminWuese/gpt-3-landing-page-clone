  ...
  return (
    <div className='gpt3__whatgpt3 section__margin' id='whatisgpt3'>
      ...
      <div className='gpt3__whatgpt3-container'>
        ...
        <Feature title='Knowledge Based' text='At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments b'/>
